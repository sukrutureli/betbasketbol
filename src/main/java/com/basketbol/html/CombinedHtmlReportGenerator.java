...
public class CombinedHtmlReportGenerator {
    ...
    public static void generateCombinedHtml(
        ...
        try {
            ...
            String scopedSubStyle = subStyle
                    .replace("h1", "#sublist h1")
                    .replace("table", "#sublist table")
                    .replace("th", "#sublist th")
                    .replace("td", "#sublist td")
                    .replace(".match-mbs", "#sublist .match-mbs")
                    .replace(".won", "#sublist .won")
                    .replace(".lost", "#sublist .lost")
                    .replace(".pending", "#sublist .pending");

            String scopedDetailStyle = detailStyle
                    .replace("h1", "#detailed h1")
                    .replace(".match", "#detailed .match")
                    .replace(".odds", "#detailed .odds")
                    .replace(".quick-summary", "#detailed .quick-summary")
                    .replace("table", "#detailed table")
                    .replace("th", "#detailed th")
            ...
            try (FileWriter fw = new FileWriter(output)) {
                ...
                // 🔹 Global layout → mobil full genişlik
                fw.write("html,body{margin:0;padding:0;}");
                fw.write("body{font-family:Arial,sans-serif;background:#f7f8fa;color:#222;}");

                // 🔹 Her iki bölüm tam genişlik
                fw.write("#sublist,#detailed{width:100%;max-width:100%;margin:0 auto;padding:0 12px;box-sizing:border-box;}");
                ...
                // 🔹 Alt HTML’lerden gelen style'ların scope edilmiş hali
