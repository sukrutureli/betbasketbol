...
public class CombinedHtmlReportGenerator {
    ...
    public static void generateCombinedHtml(List<LastPrediction> sublistPredictions,
        ...
        try {
            ...
            try (FileWriter fw = new FileWriter(output)) {
                ...
                fw.write("<title>🏀 Basketbol Tahminleri + 💰 Kupon</title>");
                fw.write("<style>");
                fw.write(subStyle);
                fw.write(detailStyle);
                fw.write("section{margin:30px auto;max-width:1200px;}hr{border:none;border-top:3px solid #0077cc;margin:40px 0;}");
